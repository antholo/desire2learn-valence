...
class D2LAppContext(object):
    ...
    def create_url_for_authentication(self, host, client_app_url,
        ...
        :param host:
            Host/port string for the back-end LMS service. To this parameter,
            this method adds the appropriate API route and parameters for a
...
class D2LUserContext(AuthBase):
    ...
    def __init__(self, host='', user_id='', user_key='', app_id='', app_key='',
        ...
        :param hostName: Host name for the back-end service.
        :param port: Port on which the host name can accept API invocations.
    ...
    def create_authenticated_url(self, api_route='/d2l/api/versions/', method='GET'):
        ...
        time = self._get_time_string()
        # return path to its original, un-URL quoted state
        bs_path = urllib.unquote_plus(api_route.lower())
